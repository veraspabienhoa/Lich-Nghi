# V84.7 - Auto Update 15:00/20:00 + email + CA1 cleaning rule + payroll/snapshot improvements (2026-08-19)
...
if selected_page == "🎂 Sinh nhật nhân sự" and has_feature_access("birthday"):
        ...
        if vpg is not None and vpg.is_enabled():
            ...
            if bg_status:
                ...
                with st.expander("📦 Xem snapshot nền hôm nay", expanded=False):
                    bg_tot = bg_snap.get("summary_totals")
                    ...
                    bg_inv = bg_snap.get("summary_invoice")
                    ...
                    bg_chk = bg_snap.get("employee_checkin")
    ...
    # Chỉ tài khoản admin được xem khối thống kê tổng quan nghỉ/phạt.
    # Các tài khoản khác không render khối này (không chỉ ẩn bằng CSS).
