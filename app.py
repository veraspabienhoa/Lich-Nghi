# V88.1 - Preview preset Bảng quản trị gọn cho trang Bảng lương + V88.0 features (2026-08-20)
...
if selected_page == "📘 Hướng dẫn sử dụng":
    ...
    # V88.1 - PREVIEW "BẢNG QUẢN TRỊ GỌN"
    # Chỉ áp dụng trong trang Bảng lương để xem trước phong cách.
    st.markdown("""
    <style id="vera-payroll-compact-preview-v881">
    [data-testid="stDataFrame"],
    [data-testid="stDataEditor"]{
    ...
    [data-testid="stDataEditor"] [role="columnheader"]{
        ...
        border-bottom:1px solid #B9BEC5 !important;
