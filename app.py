# V90.5 - Duyệt nghỉ dài hạn nâng cao + 5 đơn/tháng + tạm dừng đơn + auto trạng thái + sửa login mobile (2026-08-20)
...
def render_clickable_app_notice(message, page_name, notice_key="", kind="warning"):
    ...
    st.markdown(
        ...
        <a href="{html.escape(href)}"
           style="display:block;text-decoration:none;color:{color};
                  background:{bg};border:1px solid {border};
                  border-radius:8px;padding:10px 14px;margin:6px 0;
                  font-weight:600;cursor:pointer;">
            {safe_message}
            <span style="float:right;font-weight:700;">›</span>
        </a>
        """,
        unsafe_allow_html=True,
    )
