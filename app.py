# V87.1 - Đưa bảng Thống kê chi tiết theo từng ngày vào Giao diện tùy chỉnh + V87.0 features (2026-08-20)
...
UI_THEME_GROUP_ORDER = [
    "main_title", "sub_title", "small_title", "label_content",
...
def _theme_editor_column_config():
    return {
        ...
        "Cao": st.column_config.NumberColumn("Cao", min_value=0, max_value=120, step=1, format="%d", width=70,
                                                  help="0 = tự động; dùng cho nút/ô/tab/menu."),
...
def render_admin_theme_config_panel():
    ...
    with st.expander("🎨 Giao diện toàn hệ thống · Desktop / Mobile", expanded=True):
        st.caption(
            "Áp dụng cho toàn bộ app: tiêu đề, nội dung, bảng lớn/nhỏ, nút, ô nhập, selectbox, "
