# V86.22 - Thu nhỏ cột Thống kê chi tiết theo ngày trên mobile + V86.21 features (2026-08-20)
...
if selected_page == "📘 Hướng dẫn sử dụng":
    ...
    if not daily_thuc_nghi.empty:
        ...
        st.markdown(
            ...
            @media (max-width: 768px){
                /* V86.22: trên mobile không ép bảng rộng 940px nữa.
                   Chia đều chiều rộng màn hình và cho tiêu đề xuống dòng. */
                .vera-daily-summary-wrap{
                    overflow-x:hidden;
                    width:100%;
                }
                ...
                /* Ngày cần rộng hơn một chút; các cột số thu hẹp tối đa. */
