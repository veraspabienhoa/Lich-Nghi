# V87.5 - Giữ nguyên trang/tab sau mọi rerun toàn hệ thống + V87.4 features (2026-08-20)
...
st.markdown("""
    <style>
        ...
        h1, .custom-main-title { font-size: 28px !important; line-height: 1.22 !important;margin-top: 20px !important; }
