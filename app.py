# V90.6 - Sửa thẻ thông báo mobile hiển thị đầy đủ, không bị cắt (2026-08-20)
...
if not st.session_state.logged_in:
    # V90.5: giao diện đăng nhập mobile đầy đủ, không bị cắt tiêu đề/form khi bàn phím mở.
    st.markdown("""
    <style id="vera-login-mobile-v905">
    /* Login page không dùng min-height/padding của Header VERA SPA hay global heading. */
    @media (max-width: 768px) {
        .block-container {
