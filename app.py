# V86.9 - Có phép + Số ngày tính=0 không giới hạn người nghỉ/ngày + V86.8 features (2026-08-19)
            ...
            with st.form("form_nhap_lich_inner"):
                ...
                with col_p1:
                    val_songay = st.number_input(
                        ...
                        help=("Theo cấu hình LoaiNghi: Có phép + Số ngày tính = 0 nên không chiếm suất nghỉ trong ngày."
                              if is_zero_day_co_phep else None),
                    )
